...
//calling three functions with different
var album1 = make_album("Fareeha", "Album title 1");
var album2 = make_album("Zainab", "Album title 2");
var album3 = make_album("Irtiza", "Album title 3", 10);
//print values
console.log(album1);
console.log(album2);
console.log(album3);
